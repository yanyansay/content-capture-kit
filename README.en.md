...
For a first run, point `--out` to a temporary directory such as `output/test`. After checking the Markdown, image paths, and folder structure, point `--out` to the final folder inside your Obsidian vault.
